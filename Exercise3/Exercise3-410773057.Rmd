...
```{r ans13}
table(classData$`公-10-06`== "有看公告" & classData$`練2018-10-17-1` == "1") -> P
table(classData$`公-10-06`== "有看公告") -> Q
P[2]/Q[2]
```
...
```{r ans14}
table(classData$`公-10-06`== "沒看公告" & classData$`練2018-10-17-1` == "1") -> O
table(classData$`公-10-06`== "沒看公告") -> L
O[2]/L[2]
```
...
```{r ans22}
library(lubridate)
hwData$deadline <- ymd_hms('2018-10-24 00:00:00', tz = "Asia/Taipei")
```
...
```{r ans25}
table(hwData$early>0) -> v
table(hwData[2] = 'hw1') -> b
